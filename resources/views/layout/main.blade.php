<main class="main">
    ...
    <div class="container">
      <div class="heading heading-center mb-3">
        ...
        <ul class="nav nav-pills justify-content-center" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="new-women-link" data-toggle="tab" href="#new-women-tab" role="tab"
              aria-controls="new-women-tab" aria-selected="false">Women's</a>
          </li>
          <li class="nav-item">
          ...
          <div class="owl-carousel owl-simple carousel-equal-height" data-toggle="owl" data-owl-options='{
            ...
            <div class="product product-3 text-center">
              <figure class="product-media">
                ...
                <a href="product.html">
                  <img src="assets/images/demos/demo-10/products/product-1.jpg" alt="Product image"
                    class="product-image">
                </a>
              ...
              <div class="product-body">
                ...
                <h3 class="product-title"><a href="product.html">The North Face Back-To-Berkeley Remtlz Mesh</a>
              ...
              <div class="product-footer">
                ...
                <div class="product-nav product-nav-dots">
                  <a href="#" class="active" style="background: #5f554b;"><span class="sr-only">Color
                      name</span></a>
            ...
            <div class="product product-3 text-center">
              <figure class="product-media">
                <a href="product.html">
                  <img src="assets/images/demos/demo-10/products/product-2.jpg" alt="Product image"
                    class="product-image">
                </a>
              ...
              <div class="product-body">
                ...
                <h3 class="product-title"><a href="product.html">Nike Air Zoom Wildhorse 4</a></h3>
                <!-- End .product-title -->
                <div class="product-price">
                  $77.99
                </div><!-- End .product-price -->
            ...
            <div class="product product-3 text-center">
              <figure class="product-media">
                ...
                <a href="product.html">
                  <img src="assets/images/demos/demo-10/products/product-3.jpg" alt="Product image"
                    class="product-image">
                  <img src="assets/images/demos/demo-10/products/product-3-2.jpg" alt="Product image"
            ...
            <div class="product product-3 text-center">
              <figure class="product-media">
                ...
                <a href="product.html">
                  <img src="assets/images/demos/demo-10/products/product-4.jpg" alt="Product image"
                    class="product-image">
                </a>
              ...
              <div class="product-body">
                ...
                <h3 class="product-title"><a href="product.html">Nike Air Max Motion LW Racer</a></h3>
                <!-- End .product-title -->
                <div class="product-price">
            ...
            <div class="product product-3 text-center">
              <figure class="product-media">
                ...
                <a href="product.html">
                  <img src="assets/images/demos/demo-10/products/product-5.jpg" alt="Product image"
                    class="product-image">
                </a>
              ...
              <div class="product-body">
                ...
                <h3 class="product-title"><a href="product.html">ASICS Tiger Gel-Lyte MT</a></h3>
                <!-- End .product-title -->
                <div class="product-price">
  ...
  <div class="container">
          ...
          <div class="row">
              ...
              <div class="product product-3 text-center">
                <figure class="product-media">
                  ...
                  <div class="product-countdown-container">
                    ...
                    <div class="product-countdown countdown-compact" data-until="2019, 11, 3" data-compact="true">
                ...
                <div class="product-footer">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #af5f23;"><span class="sr-only">Color
                        name</span></a>
                    <a href="#" style="background: #806f55;"><span class="sr-only">Color name</span></a>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <span class="product-label label-primary">New</span>
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-6.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Eric Michael Sandra</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $42.99
                  </div><!-- End .product-price -->
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-7.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Jessica Simpson Blayke</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $20.99
                  </div><!-- End .product-price -->
                ...
                <div class="product-footer">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #cc6666;"><span class="sr-only">Color
                        name</span></a>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-8.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Native Shoes Miles Denim Print</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $20.99
                  </div><!-- End .product-price -->
                ...
                <div class="product-footer">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #ffca51;"><span class="sr-only">Color
                        name</span></a>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-9.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">The North Face Raedonda Boot Sneaker</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $97.99
                  </div><!-- End .product-price -->
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-10.jpg" alt="Product image"
                      class="product-image">
                  </a>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-11.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Splendid Roselyn II</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $97.99
                  </div><!-- End .product-price -->
                ...
                <div class="product-footer">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #78645f;"><span class="sr-only">Color
                        name</span></a>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  ...
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-12.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Marc Jacobs Somewhere Sport Sandal</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <span class="product-label label-primary">New</span>
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-13.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Crocs Crocband Clog</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $25.75
                  </div><!-- End .product-price -->
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
              <div class="product product-3 text-center">
                <figure class="product-media">
                  <a href="product.html">
                    <img src="assets/images/demos/demo-10/products/product-14.jpg" alt="Product image"
                      class="product-image">
                  </a>
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title"><a href="product.html">Vasque Sundowner GTX</a></h3>
                  <!-- End .product-title -->
                  <div class="product-price">
                    $109.99
                  </div><!-- End .product-price -->
    ...
    <div class="more-container text-center mt-5">
      <a href="category.html" class="btn btn-outline-lightgray btn-more btn-round"><span>View more products</span><i
