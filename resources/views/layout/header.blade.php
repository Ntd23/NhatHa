<header class="header header-8">
  ...
  @foreach ($getCategoryHeader as $value_h_c)
    <div class="nav-item dropdown position-relative d-inline-block">
      <a href="{{ route('front.category', $value_h_c->slug) }}"
      ...
      <div class="header-right">
        ...
        <div class="dropdown cart-dropdown" style="padding-top: 18px;">
          <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true"
            ...
            <span class="cart-count" style="position: absolute; top: -20px; right: -5px;">{{Cart::getContent()->count()}}</span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            <div class="dropdown-cart-products">
              ...
              <div class="product">
                ...
                <a href="{{route('front.cart_delete',$header_cart->id)}}" class="btn-remove" title="Xóa sản phẩm"><i class="icon-close"></i></a>
              </div>
						@endif
						@endforeach
            </div>
