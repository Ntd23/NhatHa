    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-sm-8 col-9 m-b-20">
          <a href="{{ route('admin.blog_category.create') }}" class="btn btn-primary float-right btn-rounded"><i
              class="fa fa-plus"></i>
                    ...
                    <td class="text-right">
                      <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="{{ route('admin.blog_category.edit', $value->id) }}"><i
                              class="fa fa-pencil m-r-5"></i>Sửa</a>
                          <a class="dropdown-item" data-toggle="modal" id="delete_blog_category" data-id="{{ $value->id }}">
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function() {
      $('body').delegate('#delete_blog_category', 'click', function() {
        let id = $(this).data('id')
        Swal.fire({
          title: 'Bạn muốn xóa danh mục bài viết này?',
          icon: 'warning',
          width: '700',
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "{{ route('admin.blog_category.delete', ['id' => ':id']) }}".replace(':id', id),
              method: 'GET',
              data: {
                _token: '{{ csrf_token() }}',
                _method: 'DELETE'
