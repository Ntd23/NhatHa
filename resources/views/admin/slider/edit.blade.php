...
@section('content')
	<div class="page-wrapper">
		<div class="content">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="page-title">Cập nhật thanh trượt</h4>
				</div>
			</div>
			@if ($errors->any())
			...
			<div class="row">
				<div class="col-lg-12">
					<form action="{{route('admin.slider.update', $getRecord->id)}}" method="post" enctype="multipart/form-data">
						{{csrf_field()}}
						<div class="card-box">
                    ...
                    @endif
						...
						<div class="card-box">
							...
							<div class="form-group row">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="button_link" value="{{ old('button_link',$getRecord->button_link) }}">
								</div>
							</div>
							<div class="form-group row">
