                    ...
                    <td class="text-right">
                      <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="{{ route('admin.product.edit', $value->id) }}"><i
                              class="fa fa-pencil m-r-5"></i>Sửa</a>
                          <a class="dropdown-item" data-toggle="modal" id="delete_product"
                            data-id="{{ $value->id }}">
      ...
      $('body').delegate('#delete_product', 'click', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "{{ route('admin.product.delete', ['id' => ':id']) }}".replace(':id', id),
              method: 'GET',
              data: {
                _token: '{{ csrf_token() }}',
                _method: 'DELETE'
