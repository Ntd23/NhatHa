    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-sm-8 col-9 m-b-20">
          <a href="{{ route('admin.create') }}" class="btn btn-primary float-right btn-rounded"><i
              class="fa fa-plus"></i>
            Thêm quản trị</a>
        </div>
      </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="{{ route('admin.edit', $value->id) }}"><i
                              class="fa fa-pencil m-r-5"></i>Sửa</a>
                          <a class="dropdown-item" data-toggle="modal" id="delete_admin" data-id="{{ $value->id }}">
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function() {
      $('body').delegate('#delete_admin', 'click', function() {
        let id = $(this).data('id')
        Swal.fire({
