    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-sm-8 col-9 text-right m-b-20">
          <a href="{{ route('admin.blog.create') }}" class="btn btn-primary float-right btn-rounded"><i
              class="fa fa-plus"></i>
            Thêm bài viết</a>
        </div>
      </div>
                  ...
                  <tr>
                    <td>
                      @if (!empty($value->getImage()))
                        <img src="{{ url($value->getImage()) }}" width="150px">
                      @endif
                    </td>
                    ...
                    <td class="text-right">
                      <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item" data-toggle="modal" id="delete_blog" data-id="{{ $value->id }}">
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function() {
      $('body').delegate('#delete_blog', 'click', function() {
        let id = $(this).data('id')
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "{{ route('admin.blog.delete', ['id' => ':id']) }}".replace(':id', id),
              method: 'GET',
              data: {
                _token: '{{ csrf_token() }}',
                _method: 'DELETE'
