...
@section('content')
  <div class="page-wrapper">
    <div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form action="{{ route('admin.shippingcharge.update',$getRecord->id) }}" method="post">
            {{ csrf_field() }}
            <div class="card-box">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="price" value="{{ old('price',$getRecord->price) }}">
                </div>
              </div>
            </div>
            <div class="card-box">
            ...
            <div class="m-t-20 text-center">
              <button class="btn btn-primary submit-btn">Cập nhật phí vận chuyển</button>
            </div>
          </form>
        </div>
      </div>
